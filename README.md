...
I don't just build models; I translate complex data into **profitable business decisions**. By combining Machine Learning engineering with *Storytelling with Data* principles, I design End-to-End architectures that eliminate operational friction and uncover hidden revenue.
...
No solo construyo modelos; traduzco datos complejos en **decisiones comerciales rentables**. Combino la ingeniería de Machine Learning con principios de *Storytelling con Datos* para diseñar arquitecturas End-to-End que eliminan la fricción operativa y descubren ingresos ocultos.

Actualmente curso el 5to año de Ingeniería en Sistemas, con foco en optimización de recursos, logística y análisis de rentabilidad corporativa.
